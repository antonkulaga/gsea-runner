...
object FrontEnd extends BindableView with scalajs.js.JSApp
{
  ...
  ViewInjector
    ...
    .register("notebook", (el, params) =>Try(new NotebookView(el,params)))
    .register("code", (el, params) =>Try(new CodeView(el,params)))
    .register("code-cell", (el, params) =>Try(new CodeCellView(el,params)))
